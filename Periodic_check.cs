...
namespace RegisterParcelsFromPC
{
    partial class Periodic_check :Form1
    {
        public void periodical_check()
        {
            ...
            List<string> target_uid = ope.get_all_uid(sqlstr.toGetList_PeriodicCheck());//先に更新対象の一覧（parcel_uidの一覧）を取得
            ...
            ope.execute_sql(sqlstr.toPeriodicCheck());//is_finished=1にするupdate文をかます
        ...
        public string get_eventtype_from_eventuid(string event_uid)
        {
            ...
            make.event_uid = event_uid;

            string event_type = ope.select_one_xx(make.toSelect_eventtype_from_eventuid(), "event_type");
            return event_type;
        }
        public string get_registerdatetime_from_eventuid(string event_uid)
        {
            ...
            string parcel_uid = ope.select_one_xx(make.toSelect_registerdatetime_from_eventuid(), "created_at");
            return parcel_uid;
        }
        ...
        public string get_parceluid_from_eventuid(string event_uid)
        {
            ...
            string parcel_uid = ope.select_one_xx(make.toSelect_parceluid_from_eventuid(), "parcel_uid");
            return parcel_uid;
        }
        ...
        public void send_slack(string parcel_uid, string message_str,int event_type)
        {
            ...
            Operation ope = new Operation(connStr);
            MakeSQLCommand make = new MakeSQLCommand();
            make.parcel_uid = parcel_uid;

            string owner_uid = ope.select_one_xx(make.toSelect_ryoseiuid_from_parceluid(), "owner_uid");
            make.ryosei_uid = owner_uid;
            string slack_uid = ope.select_one_xx(make.toSelect_slackid_from_ryoseiuid(), "slack_id");
